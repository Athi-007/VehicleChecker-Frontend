...
const Index = () => {
  ...
  const handleVehicleSearch = (registration: string, data: SnapshotBaseResponse) => {
    // Navigate to the dedicated Report page and pass snapshot data via state
    navigate(`/report/${registration}`, { state: { snapshotData: data } });
  };
